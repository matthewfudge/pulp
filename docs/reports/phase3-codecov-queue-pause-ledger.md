...
Last live check: 2026-05-01 16:59:20 EDT.
...
- Merge state: #1211 merged cleanly as `827227339a0609358ba0371a86417a868ee9879e`.
  ...
  cleanly as `e1ef408071456dbe9a66297c912edb6dcca8523b`. #1217 is now
  open from `feature/phase3-package-cli-extra-643` at `f2727c976227`.
- GitHub Actions pressure: #1215, #1216, and #1217 have PR-event
  Build/Coverage checks active. #1215 has a Linux Namespace Build failure
  while the run is still in progress, so logs are not available yet; inspect
  `25232081804` after it completes. #1216 has no failed checks. #1217 has
  no failed checks.
