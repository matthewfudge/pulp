...
var PaletteSystem = {
    ...
    currentMode: function(mode) {
        var resolved = mode;
        if (!resolved && typeof currentPaletteMode !== 'undefined') resolved = currentPaletteMode;
        return resolved === 'light' ? 'light' : 'dark';
    },

    // Generate a Pulp theme from a palette system with mode-aware semantic roles
    toThemeDiff: function(palette, mode) {
        var resolvedMode = this.currentMode(mode);
        var light = resolvedMode === 'light';
        return JSON.stringify({
            colors: {
                "bg.primary": light ? palette.neutral[50].hex : palette.neutral[950].hex,
                "bg.secondary": light ? palette.neutral[100].hex : palette.neutral[900].hex,
                "bg.surface": light ? palette.neutral[100].hex : palette.neutral[800].hex,
                "bg.elevated": light ? palette.neutral[200].hex : palette.neutral[700].hex,
                "text.primary": light ? palette.neutral[950].hex : palette.neutral[50].hex,
                "text.secondary": light ? palette.neutral[500].hex : palette.neutral[400].hex,
                "text.disabled": light ? palette.neutral[300].hex : palette.neutral[700].hex,
                "text.link": light ? palette.accent[600].hex : palette.accent[500].hex,
                "accent.primary": light ? palette.accent[600].hex : palette.accent[500].hex,
                "accent.secondary": light ? palette.accent[400].hex : palette.accent[300].hex,
                "accent.success": light ? palette.success[600].hex : palette.success[500].hex,
                "accent.warning": light ? palette.warning[600].hex : palette.warning[500].hex,
                "accent.error": light ? palette.error[600].hex : palette.error[500].hex,
                "control.track": light ? palette.neutral[200].hex : palette.neutral[800].hex,
                "control.fill": light ? palette.accent[600].hex : palette.accent[500].hex,
                "control.thumb": light ? palette.neutral[50].hex : palette.neutral[100].hex,
                "control.border": light ? palette.neutral[200].hex : palette.neutral[700].hex,
                "knob.arc": light ? palette.accent[600].hex : palette.accent[500].hex,
                "knob.arc.bg": light ? palette.neutral[200].hex : palette.neutral[800].hex,
                "knob.thumb": light ? palette.neutral[50].hex : palette.neutral[200].hex,
                "slider.track": light ? palette.neutral[200].hex : palette.neutral[800].hex,
                "slider.fill": light ? palette.accent[600].hex : palette.accent[500].hex,
                "slider.thumb": light ? palette.neutral[50].hex : palette.neutral[100].hex,
                "meter.green": light ? palette.success[600].hex : palette.success[500].hex,
                "meter.yellow": light ? palette.warning[600].hex : palette.warning[500].hex,
                "meter.red": light ? palette.error[600].hex : palette.error[500].hex,
                "waveform.line": light ? palette.accent[600].hex : palette.accent[500].hex,
                "waveform.fill": light ? palette.accent[300].hex : palette.accent[800].hex,
                "waveform.grid": light ? palette.neutral[200].hex : palette.neutral[700].hex,
                "card.empty": light ? palette.neutral[100].hex : palette.neutral[900].hex,
                "card.loading": light ? palette.neutral[200].hex : palette.neutral[700].hex,
                "card.ready": light ? palette.neutral[50].hex : palette.neutral[950].hex,
                "card.error": light ? palette.error[100].hex : palette.error[900].hex,
                "overlay.bg": light ? palette.neutral[50].hex : palette.neutral[950].hex,
                "modal.bg": light ? palette.neutral[100].hex : palette.neutral[900].hex,
                "modal.border": light ? palette.neutral[200].hex : palette.neutral[700].hex,
                "tooltip.bg": light ? palette.neutral[50].hex : palette.neutral[950].hex,
                "tooltip.text": light ? palette.neutral[950].hex : palette.neutral[100].hex,
                "tab.active": light ? palette.accent[600].hex : palette.accent[500].hex,
                "tab.inactive": light ? palette.neutral[500].hex : palette.neutral[400].hex,
                "divider": light ? palette.neutral[200].hex : palette.neutral[700].hex,
                "focus.ring": light ? palette.accent[600].hex : palette.accent[500].hex,
                "progress.track": light ? palette.neutral[200].hex : palette.neutral[800].hex,
                "progress.fill": light ? palette.accent[600].hex : palette.accent[500].hex,
                "spinner": light ? palette.accent[600].hex : palette.accent[500].hex,
                "gradient.start": light ? palette.accent[600].hex : palette.accent[600].hex,
                "gradient.end": light ? palette.accent[400].hex : palette.accent[400].hex
            }
        });
    }
};
