...
Last live check: 2026-05-01 17:31:39 EDT.
...
- Merge state: #1211 merged cleanly as `827227339a0609358ba0371a86417a868ee9879e`.
  ...
  unrelated Linux `BufferingReader` failure cleared on rerun. #1218 is
  open from `feature/phase3-docs-sync-check-extra-643` at
  `6960c4d280ee`.
- GitHub Actions pressure: #1218 has PR-event Build/Coverage checks
  active on Namespace-backed lanes and no failed checks. Codecov patch,
  Android coverage, Linux coverage, and macOS coverage are green; the
  remaining pending checks are Namespace build lanes, Windows coverage, and
  the Windows release-path gate.
