...
Last live check: 2026-05-01 17:05:43 EDT.
...
- GitHub Actions pressure: #1215, #1216, and #1217 have PR-event
  Build/Coverage checks active. #1215's first Linux Namespace Build failed
  in unrelated `BufferingReader restart clears finished state and stale
  buffered data`; `gh run rerun 25232081804 --failed` is now rerunning only
  the failed Linux job while preserving passed macOS/Windows jobs. #1216 and
  #1217 have no failed checks.
