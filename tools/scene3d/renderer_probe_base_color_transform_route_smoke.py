...
def make_scene_gltf(byte_length, views, ids):
    return {
        "asset": {
            "version": "2.0",
            "generator": "pulp-renderer3d-base-color-transform-route-contract",
        },
        "extensionsUsed": ["KHR_texture_transform"],
        "buffers": [{
            "uri": "base-color-transform-route.bin",
        ...
        "accessors": [
            ...
            {
                "bufferView": ids["texcoord0"],
                "componentType": 5126,
                "count": 3,
                "type": "VEC2",
            },
            {
                "bufferView": ids["texcoord1"],
                "componentType": 5126,
                "count": 3,
                "type": "VEC2",
            },
        ...
        "nodes": [{"name": "BaseColorTransformNode", "mesh": 0}],
        "scenes": [{"nodes": [0]}],
        "scene": 0,
    }
...
def main():
    parser = argparse.ArgumentParser(
        description="Verify renderer probe reports base-color texture transform routing.")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        (temp_path / "base-color-transform-route.bin").write_bytes(bin_bytes)
        scene_path = temp_path / "base-color-transform-route.gltf"
    ...
    print("renderer_probe_base_color_transform_route_verified=true")
    return 0
