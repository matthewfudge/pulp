"""Bindings from the local_ci facade to the desktop smoke command."""
...
DESKTOP_ACTION_SMOKE_COMMAND_EXPORTS = ("cmd_desktop_smoke",)
...
def install_desktop_action_smoke_command_helpers(
    bindings: dict[str, Any],
    names: tuple[str, ...] = DESKTOP_ACTION_SMOKE_COMMAND_EXPORTS,
) -> None:
