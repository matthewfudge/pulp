...
| Name | License | Purpose | Link |
|------|---------|---------|------|
| **Doxygen** | GPL-2.0 | API reference generation (build-time only, not redistributed) | [doxygen.nl](https://www.doxygen.nl) |
| **Pagefind** | MIT | Static search index for documentation site (build-time only, not redistributed) | [pagefind.app](https://pagefind.app) |
