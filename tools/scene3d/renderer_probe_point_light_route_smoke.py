...
def make_scene_gltf(byte_length, views, ids):
    return {
        "asset": {
            "version": "2.0",
            "generator": "pulp-renderer3d-point-light-route-contract",
        },
...
def main():
    parser = argparse.ArgumentParser(
        description="Verify renderer probe reports point light routing.")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        (temp_path / "point-light-route.bin").write_bytes(bin_bytes)
        scene_path = temp_path / "point-light-route.gltf"
    ...
    print("renderer_probe_point_light_route_verified=true")
    return 0
