...
def make_scene_gltf(byte_length, views, ids):
    return {
        "asset": {
            "version": "2.0",
            "generator": "pulp-renderer3d-spot-light-route-contract",
        },
...
def main():
    parser = argparse.ArgumentParser(
        description="Verify renderer probe reports spot light routing.")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        (temp_path / "spot-light-route.bin").write_bytes(bin_bytes)
        scene_path = temp_path / "spot-light-route.gltf"
    ...
    print("renderer_probe_spot_light_route_verified=true")
    return 0
