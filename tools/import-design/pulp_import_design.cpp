...
// Emit a starter C++ file showing how to wire pulp::view::EditorBridge
// against the just-imported design. Per pulp #709 acceptance criterion:
// "the CLI scaffolds a starter handler file that references
// pulp::view::EditorBridge".
static std::string render_bridge_scaffold(const std::string& generated_js_path) {
...
int main(int argc, char* argv[]) {
    ...
    if (*source == DesignSource::claude && emit_bridge_scaffold) {
        const auto scaffold = render_bridge_scaffold(output_file);
