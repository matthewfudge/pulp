...
| --- | --- | --- |
| Desktop target probes | Desktop doctor orchestration, Windows SSH/PowerShell probe execution, launch adapters, and automation adapters. | later `windows_probe.py`, `execution.py` |
