...
def make_scene_gltf(byte_length, views, ids):
    return {
        "asset": {
            "version": "2.0",
            "generator": "pulp-renderer3d-unlit-route-contract",
        },
        ...
        "materials": [{
            ...
            "pbrMetallicRoughness": {
                "baseColorFactor": [0.25, 0.85, 1.0, 1.0],
            },
            "extensions": {
                "KHR_materials_unlit": {},
            },
...
def main():
    parser = argparse.ArgumentParser(
        description="Verify renderer probe reports KHR_materials_unlit state.")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        (temp_path / "unlit-route.bin").write_bytes(bin_bytes)
        scene_path = temp_path / "unlit-route.gltf"
    ...
    print("renderer_probe_unlit_route_verified=true")
    return 0
