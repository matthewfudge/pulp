 ...
 *    every change to `PulpMotion.updateGeometry`. PreDraw samples after
 *    layout but before rendering, so intra-frame translation / scroll
 *    changes are visible even when layout bounds do not change.
