...
| `desktop_cli.py` | Desktop automation CLI line fragments for action success output. | Target execution, artifact persistence, report rollups, or desktop action policy. |
