    ...
    toThemeDiff: function(palette) {
        return JSON.stringify({
            colors: {
                ...
                "text.link": palette.accent[400].hex,
                ...
                "knob.arc": palette.accent[500].hex,
                "knob.arc.bg": palette.neutral[700].hex,
                "knob.thumb": palette.neutral[200].hex,
                "slider.track": palette.neutral[700].hex,
                "slider.fill": palette.accent[500].hex,
                "slider.thumb": palette.neutral[100].hex,
                "meter.green": palette.success[500].hex,
                "meter.yellow": palette.warning[500].hex,
                "meter.red": palette.error[500].hex,
                "waveform.line": palette.accent[400].hex,
                "waveform.fill": palette.accent[800].hex,
                "waveform.grid": palette.neutral[700].hex,
                "card.empty": palette.neutral[800].hex,
                "card.loading": palette.neutral[800].hex,
                "card.ready": palette.neutral[800].hex,
                "card.error": palette.error[900].hex,
                "overlay.bg": palette.neutral[950].hex,
                "modal.bg": palette.neutral[900].hex,
                "modal.border": palette.neutral[700].hex,
                "tooltip.bg": palette.neutral[800].hex,
                "tooltip.text": palette.neutral[100].hex,
                "tab.active": palette.accent[500].hex,
                "tab.inactive": palette.neutral[600].hex,
                "divider": palette.neutral[700].hex,
                "focus.ring": palette.accent[400].hex,
                "progress.track": palette.neutral[700].hex,
                "progress.fill": palette.accent[500].hex,
                "spinner": palette.accent[400].hex,
                "gradient.start": palette.accent[600].hex,
                "gradient.end": palette.accent[400].hex
            }
        });
    }
};
