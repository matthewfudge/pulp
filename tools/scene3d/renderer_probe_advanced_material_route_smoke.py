...
def make_scene_gltf(byte_length, views, ids):
    return {
        "asset": {
            "version": "2.0",
            "generator": "pulp-renderer3d-advanced-material-route-contract",
        },
        "extensionsUsed": [
        ...
        "buffers": [{
            "uri": "advanced-material-route.bin",
        ...
        "materials": [{
            "name": "AdvancedPhysicalMat",
            "doubleSided": True,
            "pbrMetallicRoughness": {
                "baseColorFactor": [0.75, 0.82, 0.92, 1.0],
            },
            "extensions": {
                "KHR_materials_clearcoat": {
                    "clearcoatFactor": 0.6,
...
def main():
    parser = argparse.ArgumentParser(
        description="Verify renderer probe reports advanced material deferral.")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        (temp_path / "advanced-material-route.bin").write_bytes(bin_bytes)
        scene_path = temp_path / "advanced-material-route.gltf"
    ...
    print("renderer_probe_advanced_material_route_verified=true")
    return 0
