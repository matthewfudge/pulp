...
Last live check: 2026-05-01 19:06:08 EDT.
...
- Refill: opened #1228 from
  ...
  `tools/audit.py`.
- GitHub Actions pressure: #1226-#1228 have PR-event Build/Coverage
  checks active or queued on Namespace-backed lanes and no failed checks.
  Main changed after #1224/#1225 merged, so re-check mergeability for #1226-#1228
