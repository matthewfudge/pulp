"""Bindings from the local_ci facade to the desktop inspect command."""
...
DESKTOP_ACTION_INSPECT_COMMAND_EXPORTS = ("cmd_desktop_inspect",)
...
def install_desktop_action_inspect_command_helpers(
    bindings: dict[str, Any],
    names: tuple[str, ...] = DESKTOP_ACTION_INSPECT_COMMAND_EXPORTS,
) -> None:
