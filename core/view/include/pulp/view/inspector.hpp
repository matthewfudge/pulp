...
public:
    ...
    // Find a view by its design-import anchor id. Returns nullptr for an
    // empty anchor or when no view in the tree carries it. Used by the
    // inspector's source-jump resolver to map an anchor back to a live View*.
